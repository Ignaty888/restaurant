...
{
    public partial class AddEditIngridientForm : Form
    {
        /// <summary>
        ...
        /// </summary>
        public AddEditIngridientForm(Ingredient item, Repository repository)
        {
        ...
        /// </summary>
        public AddEditIngridientForm(Repository repository)
        {
        ...
        private bool Check()
        {
            if (string.IsNullOrWhiteSpace(textBoxIngredientName.Text))
            {
                MessageBox.Show("Не верно заполнено поле Наименование ингридиента", "", MessageBoxButtons.OK,
        ...
        private void buttonAddEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (_edit)// если стоит флаг редактирования
                {
                    ...
                    _item.IngridientName = textBoxIngredientName.Text;
                    _repository.UpdateIngredient(_item);
                }
                else
                {
                    ...
                    {
                        IngridientName = textBoxIngredientName.Text,
                    };
        ...
        private void AddEditPostForm_Load(object sender, EventArgs e)
        {
            ...
            if (_item != null)
            {
                ...
                Text = "Редактирование";
                textBoxIngredientName.Text = _item.IngridientName;
            }
            else
            {
