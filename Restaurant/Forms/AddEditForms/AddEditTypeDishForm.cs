...
{
    public partial class AddEditTypeDishForm : Form
    {
        /// <summary>
        ...
        /// </summary>
        public AddEditTypeDishForm(TypeDish item, Repository repository)
        {
        ...
        /// </summary>
        public AddEditTypeDishForm(Repository repository)
        {
        ...
        private bool Check()
        {
            if (string.IsNullOrWhiteSpace(textBoxTypeDish.Text))
            {
                MessageBox.Show("Не верно заполнено поле Тип блюда", "", MessageBoxButtons.OK,
        ...
        private void buttonAddEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (_edit)// если стоит флаг редактирования
                {
                    ...
                    _item.TypeDishName = textBoxTypeDish.Text;
                    _item.Detailed = textBoxDetailed.Text;
                    _repository.UpdateTypeDish(_item);
                }
                else
                {
                    ...
                    _item = new TypeDish
                    {
                        TypeDishName = textBoxTypeDish.Text,
                        Detailed = textBoxDetailed.Text
                    };
        ...
        private void AddEditPostForm_Load(object sender, EventArgs e)
        {
            ...
            if (_item != null)
            {
                ...
                textBoxTypeDish.Text = _item.TypeDishName;
                textBoxDetailed.Text = _item.Detailed;
            }
            else
            {
